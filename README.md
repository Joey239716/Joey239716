...
I'm a CS student focused on building high-performance backend systems. My experience at CanDeal and CIBC involved everything from automating compliance workflows to building a threat intelligence pipeline, projects where reliability and low latency are vital.

I enjoy solving infrastructure-level problems: optimizing algorithms, reducing costs, and making systems do more with less.

* 🛰️ **Currently:** Building a v2v fleet communication system
...
![snake gif](https://github.com/Joey239716/Joey239716/blob/output/github-snake-dark.svg)
